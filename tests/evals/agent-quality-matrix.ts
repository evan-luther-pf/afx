export const SHARED_MODEL_CONTEXT_CONTRACT = "afx.shared_model_context.v1";
...
export interface CoveredEntrypoint {
  entrypoint: "interactive" | "afx ask" | "ACP" | "subagent";
...
export const AGENT_QUALITY_BASELINE_MATRIX: readonly AgentQualityMatrixRow[] = [
  ...
  },
  {
    ...
    userPrompt: "Look for changes/last commits in afx.",
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity in afx.shared_model_context.v1."),
    ],
  },
  {
    ...
    currentBaselineResult: {
      status: "partial",
      notes:
        "Live ./zig-out/bin/afx ask --auto --json --no-save answered from existing context with zero tool calls. First tool: none; forbidden tools: none; behavior cited src/core/slash_commands/command_specs.zig but did not perform local discovery first.",
    },
    targetResult:
      "Starts with local discovery and identifies src/core/slash_commands/command_specs.zig from local evidence.",
    coveredEntrypoints: [
      askEntrypoint("Uses workspace_identity and available_tools from afx.shared_model_context.v1."),
    ],
  },
  {
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/afx ask --auto --json --no-save used grep_files first and made five grep_files calls total. Forbidden tools: none; behavior reported concrete local matches in command_policy.zig, tool_permission.zig, and terminal.zig.",
    },
    targetResult: "Uses local search tools only and reports concrete local matches.",
    coveredEntrypoints: [
      askEntrypoint("Depends on available_tools and workspace_identity from afx.shared_model_context.v1."),
    ],
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Applies to long --auto --json local source investigations in afx ask."),
  ...
  },
  {
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/afx ask --auto --json --no-save used read_file first, then a second read_file. Forbidden tools: none; behavior inspected MCP runtime/docs before answering and did not ask the user.",
    },
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity and workspace_identity from afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    userPrompt:
      "Read https://github.com/evan-luther-pf/afx/pull/57 comments, and if gh is missing or unauthenticated report the blocker.",
    failureCategory: "GitHub routing",
    expectedFirstTool: {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity and available_tools from afx.shared_model_context.v1."),
    ],
  },
  {
  ...
  },
  {
    ...
    userPrompt: "Read https://github.com/evan-luther-pf/afx/pull/57 comments.",
    failureCategory: "GitHub routing",
    expectedFirstTool: {
      category: "GitHub CLI metadata read",
      tools: ["terminal"],
    ...
    deterministicCoverage: {
      ...
      status: "planned",
      notes:
        "Concrete public PR fixture chosen; a recorded JSON fixture can assert gh routing for evan-luther-pf/afx#57.",
    },
    modelBackedEval: {
      required: true,
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/afx ask --auto --json --no-save used terminal.exec first with gh pr view 57 --repo evan-luther-pf/afx --comments. Forbidden tools: none; behavior summarized PR review comments and bot deploy comments from gh output.",
    },
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Depends on session_metadata from afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Depends on session_metadata in afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Uses session_metadata from afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Uses permission_mode and available_tools from afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Uses workspace_identity and session_metadata from afx.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on available_tools and web routing prompt guidance in afx.shared_model_context.v1."),
    ],
  },
  {
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on session_metadata and available_tools from afx.shared_model_context.v1."),
