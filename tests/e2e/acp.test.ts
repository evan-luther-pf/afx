...
function findPersistedAcpDeliveryIds(
  ...
  const path = join(root.home, ".afx", "sessions", childId, "subagent", "communication.json");
...
function acpSubagentState(
  ...
  const path = join(root.home, ".afx", "sessions", childId, "subagent", "control.json");
...
function expectAcpParentHistoryClean(
  ...
  const sessionDir = join(root.home, ".afx", "sessions", parentSessionId);
...
async function waitForTerminalHostExit(root: string): Promise<void> {
  const identityPath = join(root, "home", ".afx", "terminal-host", "host.json");
...
async function continueRecovery(client: AcpClient, timeoutMs = LIVE_TIMEOUT) {
  ...
  client.send({
    ...
    params: {
      prompt: [],
      _meta: { afx: { continueRecovery: true } },
    },
  });
...
describe("acp: model-independent", () => {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-features-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-available-commands-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-model-recovery-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-continuation-text-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-read-file-fifo-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-reload-model-recovery-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-large-prompt-");
      const gateway = startFakeGateway(
  ...
  test(
    ...
    async () => {
      const root = createShortIsolatedRoot("afx-acp-terminal-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-added-root-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-context-limits-");
      writeFileSync(
  ...
  test(
    ...
    async () => {
      ...
      for (const testCase of cases) {
        const root = createIsolatedRoot(`afx-acp-bounded-omission-${testCase.label}-`);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-project-omissions-");
  ...
  test(
    ...
    async () => {
      ...
      for (const testCase of cases) {
        const root = createIsolatedRoot(`afx-acp-aggregate-omissions-${testCase.label}-`);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-http-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-legacy-remote-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-auth-required-");
      let mcpRequests = 0;
      ...
      try {
        ...
        expect(
          existsSync(join(root.home, ".afx", "mcp-credentials")),
        ).toBe(false);
        expect(client.stderr).toBe("");
      } finally {
        await client?.close();
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-bearer-");
      const httpFixture = startModernMcpHttpFixture("json");
      ...
      try {
        ...
        const session = readFileSync(
          join(root.home, ".afx", "sessions", sessionId, "session.json"),
          "utf8",
        );
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-http-lifecycle-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-http-cancel-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-http-eof-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-http-failures-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-lifecycle-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-mrtr-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-unadvertised-url-");
  ...
  test(
    ...
    async () => {
      ...
      for (const testCase of cases) {
        const root = createIsolatedRoot(`afx-acp-mcp-cap-${testCase.label}-`);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-elicitation-form-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-elicitation-eof-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-elicitation-url-");
      ...
      try {
        ...
        expect(direct.elicitationId).toMatch(/^afx-\d+$/);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-legacy-elicitation-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-legacy-url-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-legacy-url-early-");
      const fixture = startLegacyStreamableHttpFixture("2025-11-25", {
        mode: "elicitation_url",
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-legacy-url-decline-");
      const fixture = startLegacyStreamableHttpFixture("2025-11-25", {
        mode: "elicitation_url",
        completeBeforeElicitationResponse: true,
      });
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-elicitation-cancel-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-isolation-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-admission-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-cancel-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-mcp-eof-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-invalid-initialize-");
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
          env: {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-prompt-without-session-");
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
          env: {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-image-rejection-");
  ...
  test(
    ...
    async () => {
      const acceptedRoot = createIsolatedRoot("afx-acp-auto-file-accepted-");
      const blockedRoot = createIsolatedRoot("afx-acp-auto-file-check-");
      try {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-auto-recovery-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-terminal-list-");
      const boundary = createPromptTerminalBoundary(root.root);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-terminal-prompt-");
      const boundary = createPromptTerminalBoundary(root.root);
      const gateway = startFakeGateway([
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-terminal-validation-");
      const boundary = createPromptTerminalBoundary(root.root);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-terminal-failure-");
      const boundary = createPromptTerminalBoundary(root.root);
      const gateway = startFakeGateway([
        fakeGatewaySse([
          {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-auth-failure-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-running-prompt-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-terminal-shutdown-");
      const boundary = createPromptTerminalBoundary(root.root);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-cancel-framing-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-malformed-arguments-");
      const tracePath = join(root.root, "trace.log");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-missing-auth-");
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
          env: {
        ...
        expect(resp.error.message).toContain("afx login");
        expect(resp.error.message).toContain("afx providers");
  ...
  test(
    ...
    async () => {
      const root = mkdtempSync(join(tmpdir(), "afx-acp-no-create-"));
      try {
        const home = join(root, "home");
        const workspace = join(root, "workspace");
        mkdirSync(home);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-workspace-session-list-");
      const gateway = startFakeGateway([]);
      try {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-load-contention-");
      const gateway = startFakeGateway([]);
  ...
  test(
    ...
    async () => {
      const root = mkdtempSync(join(tmpdir(), "afx-acp-write-sentinel-"));
      try {
        const home = join(root, "home");
        const workspace = join(root, "workspace");
        mkdirSync(home);
  ...
  test(
    ...
    async () => {
      const root = mkdtempSync(join(tmpdir(), "afx-acp-exact-id-"));
      try {
        const home = join(root, "home");
        const workspace = join(root, "workspace");
        mkdirSync(home);
        ...
        const sessionDir = join(home, ".afx", "sessions", "last");
        mkdirSync(sessionDir, { recursive: true, mode: 0o700 });
        chmodSync(join(home, ".afx"), 0o700);
        chmodSync(join(home, ".afx", "sessions"), 0o700);
        chmodSync(sessionDir, 0o700);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-load-execution-");
      writeFileSync(
  ...
  test(
    ...
    async () => {
      const deniedRoot = createIsolatedRoot("afx-acp-deterministic-denied-");
      const allowedRoot = createIsolatedRoot("afx-acp-deterministic-allowed-");
      ...
      writeFileSync(
        join(deniedRoot.home, ".afx", "settings.json"),
        JSON.stringify({
          permission: {
            edit: {
      ...
      try {
        ...
        writeFileSync(
          join(allowedRoot.home, ".afx", "settings.json"),
          JSON.stringify({
            permission: {
              edit: {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-length-tool-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-silent-tools-length-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-explicit-skill-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-stale-explicit-skill-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-skill-diagnostics-");
      const tracePath = join(root.root, "trace.log");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-context-refresh-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-resource-context-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-tool-context-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-permission-parity-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-permission-reject-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-command-approval-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-subagent-tools-");
  ...
  for (const childMode of ["one_off", "persistent"] as const) {
    ...
    test(
      ...
      async () => {
        const root = createIsolatedRoot(`afx-acp-${label}-child-mcp-`);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-one-off-load-");
      ...
      try {
        ...
        expect(result.promptResult.result.stopReason).toBe("end_turn");
        const sessionsDir = join(root.home, ".afx", "sessions");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-parent-delivery-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-64k-parent-delivery-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-active-mode-");
      const heldResponse = deferred<Response>();
      ...
      try {
        ...
        expect(customProviderGuidanceState(codeRequest).guidanceMessageIndices).toEqual([]);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-auto-review-cancel-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-codex-subagent-");
      const gateway = startFakeGateway([]);
      ...
      try {
        ...
        const childState = JSON.parse(
          readFileSync(
            join(root.home, ".afx", "sessions", childId, "session.json"),
            "utf8",
          ),
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-grok-subagent-");
      const gateway = startFakeGateway([]);
      ...
      try {
        ...
        const childState = JSON.parse(
          readFileSync(join(root.home, ".afx", "sessions", childId, "session.json"), "utf8"),
        ) as { preferences: { provider: string; model: string } };
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-permission-shutdown-");
...
describe("acp: model catalog authentication", () => {
  ...
  for (const scenario of [
    ...
    test(
      ...
      async () => {
        const root = createIsolatedRoot("afx-acp-team-model-options-");
        const gateway = startFakeGateway([], {
          models(request) {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-model-override-");
...
describe.skipIf(!HAS_API_KEY)("acp: model-backed protocol", () => {
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-new-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-list-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-set-mode-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-load-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-set-config-");
      const gateway = startFakeGateway([], {
        models: [
          { id: FAKE_GATEWAY_MODEL, type: "language", tags: ["tool-use"] },
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-chatgpt-route-");
      const gateway = startFakeGateway([]);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-grok-route-");
      const gateway = startFakeGateway([]);
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-prompt-");
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-session-cancel-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-model-options-");
      const gateway = startFakeGateway([], {
        models: [
          { id: FAKE_GATEWAY_MODEL, type: "language", tags: ["tool-use"] },
  ...
  test(
    ...
    async () => {
      const root = createIsolatedRoot("afx-acp-no-stderr-");
      const gateway = startFakeGateway([]);
      try {
        client = await AcpClient.create({
          cwd: root.workspace,
