...
function createArtifactRoot(): string {
  ...
  if (configured) {
    ...
    artifactRoot = realpathSync(
      mkdtempSync(join(tmpdir(), "afx-streamed-tool-lifecycle-artifacts-")),
    );
  }
  return artifactRoot;
}
...
function readSubagentCommunicationRecords(home: string): string[] {
  const sessionsRoot = join(home, ".afx", "sessions");
...
async function runCanonicalLifecycleFixture(
  ...
  root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-gateway-ordering-")));
  ...
  if (stage === "correlation-corrected" || stage === "corrected") {
    ...
    if (reachedFinal) {
      ...
      const help = await waitForPaneOrDone(session, "Commands ", donePath);
...
async function launchRouteRecoveryTui(
  ...
  mkdirSync(join(home, ".afx"), { recursive: true });
  mkdirSync(workspacePath, { recursive: true });
  writeFileSync(join(home, ".afx", "settings.json"), JSON.stringify(options.settings ?? {}));
  const workspace = realpathSync(workspacePath);
...
describe.skipIf(!tmuxAvailable())("TUI gateway stream lifecycle", () => {
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-full-window-output-limit-",
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-followup-input-counter-",
        [
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-live-token-counter-retry-",
        [
          new Response(
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-empty-assistant-history-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-route-recovery-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
  ...
  test(
    ...
    async () => {
      ...
      expect(queuedGateway.requests.length).toBe(1);
      expect(scrollback).not.toContain("What should afx do?");
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-recovery-active-continue-",
        [
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-recovery-tool-lifecycle-",
        [
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-recovery-fast-backoff-restart-",
  ...
  test(
    ...
    async () => {
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-recovery-backoff-cancel-",
        [
  ...
  test(
    ...
    async () => {
      ...
      const { queuedGateway, stderrPath } = await launchRouteRecoveryTui(
        "afx-tui-recovery-partial-continue-",
        [
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-read-tool-result-failure-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-streaming-caret-")));
      const home = join(root, "home");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-idle-submit-order-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-prompt-boundary-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-cancel-integrity-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-order-")));
      const home = join(root, "home");
      ...
      writeFileSync(join(home, ".afx", "AGENTS.md"), `${oldGlobalRule}\n`);
      ...
      writeFileSync(join(home, ".afx", "AGENTS.md"), `${newGlobalRule}\n`);
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-review-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-review-escape-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-semantic-drafts-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-file-picker-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-next-turn-model-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
      ...
      expect(JSON.parse(readFileSync(join(home, ".afx", "settings.json"), "utf8")))
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-model-picker-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-empty-enter-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-inline-delete-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-image-yank-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-post-cancel-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-queued-cancel-all-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const tracePath = join(root, "trace.log");
      const stderrPath = join(root, "stderr.log");
      ...
      if (stage === "baseline-silent" || stage === "fatal-reported") {
        ...
        expect(observed.stderr).toBe(
          stage === "baseline-silent"
            ? ""
            : "afx: LifecycleReconciliationCollision\n",
        );
        return;
      }
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-status-scrollback-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-launch-history-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-mcp-approval-")));
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-child-mcp-approval-")));
      const dynamicToolName = "mcp_fixture_echo";
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-narrow-mcp-approval-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const dynamicToolName = "mcp_fixture_echo";
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-mcp-lifecycle-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tracePath = join(root, "afx-trace.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
      mkdirSync(workspace, { recursive: true });
      writeFileSync(
        join(home, ".afx", "settings.json"),
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-unsupported-tool-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const resumedStderrPath = join(root, "resumed-stderr.log");
      ...
      expect(compact).toContain(failedRow);
      expect(compact).toContain(completedRow);
      ...
      await session.sendKeys("C-o");
      await session.waitForText(failedRow, TIMEOUT);
      ...
      expect(resumed).toContain(failedRow);
      expect(resumed).toContain(completedRow);
  ...
  test(
    "default OMP tool display frames mutations and commands while reads stay inline",
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-visual-tools-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const commandOutput = Array.from(
        { length: 12 },
        (_, index) => `VISUAL_COMMAND_${String(index + 1).padStart(2, "0")}`,
      ).join("\n");
      const editContent = "VISUAL_EDIT_DIFF\n";
      const oldEditContent = Array.from(
        { length: 45 },
        (_, index) => `OLD_EDIT_${String(index + 1).padStart(2, "0")}`,
      ).join("\n") + "\n";
      const newEditContent = Array.from(
        { length: 45 },
        (_, index) => `NEW_EDIT_${String(index + 1).padStart(2, "0")}`,
      ).join("\n") + "\n";
      const readContent = "VISUAL_READ_BODY\n";
      const finalText = "VISUAL_TOOL_BLOCKS_FINAL";
      mkdirSync(join(home, ".afx"), { recursive: true });
      mkdirSync(workspace, { recursive: true });
      writeFileSync(join(home, ".afx", "settings.json"), "{}");
      writeFileSync(join(workspace, "read.txt"), readContent);
      writeFileSync(join(workspace, "edit.txt"), oldEditContent);

      const visualGateway = startFakeGateway([
        fakeGatewaySse([
          {
            type: "tool-call",
            toolCallId: "visual_write",
            toolName: "write_file",
            input: { path: "visual.txt", content: editContent },
          },
          {
            type: "tool-call",
            toolCallId: "visual_edit",
            toolName: "edit_file",
            input: { path: "edit.txt", old_string: oldEditContent, new_string: newEditContent },
          },
          {
            type: "tool-call",
            toolCallId: "visual_command",
            toolName: "terminal",
            input: { action: "exec", command: `printf '${commandOutput}'` },
          },
          {
            type: "tool-call",
            toolCallId: "visual_read",
            toolName: "read_file",
            input: { path: "read.txt" },
          },
          {
      ...
      session = await TmuxSession.create({
        ...
        env: {
          HOME: home,
          AI_GATEWAY_API_KEY: "fake-visual-tools-key",
          VERCEL_OIDC_TOKEN: undefined,
          FX_AUTO_UPGRADE: "0",
          FX_PERMISSION_MODE: "auto",
          FX_GATEWAY_BASE_URL: visualGateway.baseUrl,
          FX_GATEWAY_CHAT_URL: visualGateway.chatUrl,
          FX_E2E_GATEWAY_CHAT_URL: visualGateway.chatUrl,
          FX_MODEL: MODEL,
        },
      });

      await session.waitForComposer(TIMEOUT);
      await session.sendText("Write one file, edit another, read a third, and run the command.");
      await session.waitForText(finalText, TIMEOUT);
      const scrollback = await session.captureFullScrollback();

      expect(scrollback).toContain("╭─── Wrote visual.txt +1");
      expect(scrollback).toContain("╭─── Edited edit.txt");
      expect(scrollback).toContain("OLD_EDIT_10");
      expect(scrollback).toContain("NEW_EDIT_40");
      expect(scrollback).toContain("╭─── Ran printf");
      expect(scrollback).toContain("├─── Output");
      expect(scrollback).toContain("VISUAL_COMMAND_10");
      expect(scrollback).not.toContain("VISUAL_COMMAND_11");
      expect(scrollback).toContain("… 2 lines more");
      expect(scrollback).toContain("● Read read.txt");
      expect(scrollback).not.toContain("╭─── Read read.txt");
      expect(scrollback).toContain(editContent.trim());
      expect(scrollback).not.toContain(readContent.trim());
      expect(readFileSync(join(workspace, "visual.txt"), "utf8")).toBe(editContent);
      expect(readFileSync(join(workspace, "edit.txt"), "utf8")).toBe(newEditContent);
      expect(readFileSync(stderrPath, "utf8")).toBe("");
    },
    TIMEOUT,
  );
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-command-summary-")));
      const home = join(root, "home");
      ...
      writeFileSync(
        join(home, ".afx", "settings.json"),
        JSON.stringify({ visual_tool_blocks: false }),
      );
      ...
      await session.waitForText(`Ran ${firstDisplayCommand}`, TIMEOUT);
      await session.sendKeys("C-o");
      ...
      const fullAtSummary = await session.waitForText(`Ran ${firstDisplayCommand}`, TIMEOUT);
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-minimal-tool-groups-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
      ...
      expect(running).toContain("Read seven.txt");
      expect(running).toContain("Running sleep 1; printf SECOND_GROUP_LIVE_COMMAND");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-minimal-cancelled-tool-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
      ...
      const feedback = "Cancelled sleep 30";
  ...
  test(
    "current compact view omits provisional tool calls that never execute",
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-minimal-not-executed-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
      ...
      await waitForCondition(
        () => provisionalGateway.requests.length === 1,
        "provisional read response",
      );
      await session.waitForPane(hasEmptyComposer, TIMEOUT);
      const compact = await session.captureFullScrollback();
      expect(compact).not.toContain("never-read.txt");
      expect(compact).not.toContain("Running read");
      expect(readFileSync(stderrPath, "utf8")).toBe("");
    },
    TIMEOUT,
  );
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-small-startup-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      mkdirSync(join(home, ".afx"), { recursive: true });
      mkdirSync(workspacePath, { recursive: true });
      ...
      expect(readFileSync(join(artifacts, "stderr.log"), "utf8")).toBe(
        "afx needs at least 5 terminal rows.\n",
      );
  ...
  test(
    ...
    async () => {
      root = realpathSync(
        mkdtempSync(join(tmpdir(), "afx-tui-invalid-added-root-")),
      );
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-gateway-lifecycle-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      mkdirSync(join(home, ".afx"), { recursive: true });
      mkdirSync(workspace, { recursive: true });
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-auto-review-activity-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-run-command-provisional-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-provider-search-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
      const tracePath = join(root, "trace.log");
      const sourceUrl = "https://example.test/afx-provider-search";
      ...
      const providerGateway = startFakeGateway([
        fakeGatewaySse([
          {
            type: "tool-call",
            toolCallId: "provider_search_outer",
            toolName: "web_search",
            input: { query: "provider fixture" },
          },
          {
            type: "finish",
            finishReason: { unified: "tool-calls", raw: "tool-calls" },
        ...
        fakeGatewaySse([
          ...
          },
          {
            ...
            toolCallId: "provider_search_direct",
            result: {
              results: [{ title: "AFX provider source", url: sourceUrl }],
            },
          },
          {
            type: "finish",
      ...
      session = await TmuxSession.create({
        ...
        env: {
          ...
          FX_MODEL: MODEL,
          FX_WEB_SEARCH_EXCLUDE: "tavily,brave,jina,firecrawl",
          FX_RECORD: tapePath,
          FX_RECORD_INPUT: "1",
          FX_TRACE_LOG: tracePath,
          FX_TRACE_SCOPES: "agent,gateway,stream,tool,sse,worker,input,prompt,ui_activity,command_output",
      ...
      await session.waitForText(finalText, TIMEOUT);
      await waitForCondition(
        () => providerGateway.requests.length === 3,
        "native search synthesis request",
      );

      const initialRequest = parseGatewayRequest(providerGateway.requests[0]!.body);
      const continuingRequest = parseGatewayRequest(providerGateway.requests[2]!.body);
      ...
      for (const request of [initialRequest, continuingRequest]) {
        ...
        expect(toolNames.filter((name) => name === "web_search"))
          .toHaveLength(1);
      ...
      const compact = await session.captureFullScrollback();
      expect(compact).toContain("Web Search: Perplexity");
      ...
      expect(replay).toContain("Web Search: Perplexity");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-multiline-command-")));
      const home = join(root, "home");
      const workspacePath = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-parallel-command-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tapePath = join(root, "session.fxtape");
      ...
      expect(scrollback).toContain("SECOND_CMD_LINE_06");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-gateway-length-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      ...
      await session.sendText("/help");
      await session.waitForPane((pane) => /Commands \d+/.test(pane), TIMEOUT);
      expect(gateway.requestCount()).toBe(1);
      await session.sendKeys("Escape");
    },
    TIMEOUT,
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-model-cache-picker-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      ...
      await session.waitForPane((pane) => pane.includes("𝒂𝒇x") && !pane.includes("Tab Provider"), TIMEOUT);
    },
    TIMEOUT,
  );
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-model-cache-exit-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      const tracePath = join(root, "trace.log");
...
describe.skipIf(!tmuxAvailable())("transcript scrollback release", () => {
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-sb-tool-groups-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      mkdirSync(join(home, ".afx"), { recursive: true });
      ...
      writeFileSync(join(home, ".afx", "settings.json"), sbSettings());
      writeFileSync(stderrPath, "");
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-sb-release-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
      ...
      expect(countOccurrences(scrollback, "tool call")).toBe(0);
      for (let index = 1; index <= 17; index += 1) {
        expect(
          countOccurrences(
            scrollback,
  ...
  test(
    ...
    async () => {
      root = realpathSync(mkdtempSync(join(tmpdir(), "afx-tui-sb-batch-")));
      const home = join(root, "home");
      const workspace = join(root, "workspace");
      const stderrPath = join(root, "stderr.log");
