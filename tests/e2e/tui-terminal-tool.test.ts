...
async function waitForTerminalHostExit(home: string): Promise<void> {
  const identityPath = join(home, ".afx", "terminal-host", "host.json");
...
async function cleanupNarrowReturn(
  ...
  const identityPath = join(fixture.home, ".afx", "terminal-host", "host.json");
...
function terminalTransportPaths(home: string) {
  const durableDir = join(home, ".afx", "terminal-host");
  ...
  const dir = join(base, `afx-terminal-${process.getuid?.() ?? 0}-${digest}`);
...
function createFixture(prefix: string, endpointBytes?: number) {
    ...
    : join(
      ...
      "x".repeat(
        endpointBytes -
          ...
          Buffer.byteLength("/.afx/terminal-host/host.sock") -
          1,
      ),
    );
  ...
  if (transport.dir !== join(home, ".afx", "terminal-host")) {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-narrow-return-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-narrow-failure-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway);
    const interactiveFlags = TERMINAL_FIXTURE_SHELL.endsWith("/zsh")
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-delayed-");
    const scriptPath = writeTakeoverFixture(fixture);
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
...
for (const failure of [
  ...
  test.skipIf(!tmuxAvailable())(
    ...
    async () => {
      const fixture = createFixture(`afx-tui-terminal-takeover-${failure}-`);
      const scriptPath = writeTakeoverFixture(fixture);
      const gateway = startFakeGateway([]);
      gateways.push(gateway);
      const active = await launch(fixture, gateway, {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-tmux-");
    const scriptPath = writeTakeoverFixture(fixture);
...
for (const backend of ["native", "tmux"] as const) {
  test.skipIf(!tmuxAvailable())(
    `abrupt AFX death leaves a live ${backend} takeover discoverable and reclaimable on exact task resume`,
    async () => {
      const fixture = createFixture(`afx-tui-terminal-reclaim-${backend}-`);
      const scriptPath = writeTakeoverFixture(fixture);
      const gatewayResponses = [
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-takeover-loss-");
    const scriptPath = writeTakeoverFixture(fixture);
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-action-schema-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-null-placeholder-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-correction-loop-");
    const firstBatch = [
      {
        id: "terminal_s_1",
        input: {
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-empty-command-");
    let terminalSessionId = "";
    const gateway = startFakeGateway([
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-monitor-path-scope-");
    ...
    const gateway = startFakeGateway([
      ...
      (body) => {
        ...
        const identity = JSON.parse(
          readFileSync(
            join(fixture.home, ".afx", "terminal-host", "host.json"),
            "utf8",
          ),
        ) as { pid: string };
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-public-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-lease-payload-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-public-controls-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-public-signal-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-public-wait-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-public-monitor-");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-long-home-", 141);
    const durableDir = join(fixture.home, ".afx", "terminal-host");
    const durableSocket = join(durableDir, "host.sock");
    const transport = terminalTransportPaths(fixture.home);
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-direct-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway);
    ...
    const promptHistory = readFileSync(
      join(fixture.home, ".afx", "history.jsonl"),
      "utf8",
    );
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-direct-immediate-quit-");
    ...
    expect(
      readFileSync(join(fixture.home, ".afx", "history.jsonl"), "utf8"),
    ).toContain("/quit");
    expect(readFileSync(fixture.stderrPath, "utf8")).toBe("");
...
test.skipIf(!tmuxAvailable())(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-queue-");
    const gateway = startFakeGateway([]);
    gateways.push(gateway);
    const active = await launch(fixture, gateway, {
...
test.skipIf(!tmuxAvailable() || loginProfileName === null)(
  ...
  async () => {
    const fixture = createFixture("afx-tui-terminal-failed-start-");
    ...
    expect(existsSync(join(fixture.home, ".afx", "history.jsonl"))).toBe(false);
    expect(readFileSync(fixture.stderrPath, "utf8")).toBe("");
    ...
    await waitForTerminalHostExit(fixture.home);
    expect(
      existsSync(join(fixture.home, ".afx", "terminal-host", "host.json")),
    ).toBe(false);
