...
const fxBin = resolve(import.meta.dirname, "../../../zig-out/bin/afx");
const root = mkdtempSync(join(tmpdir(), "afx-mcp-conformance-client-"));
const home = join(root, "home");
const workspace = join(root, "workspace");
mkdirSync(join(home, ".afx", "skills"), { recursive: true, mode: 0o700 });
