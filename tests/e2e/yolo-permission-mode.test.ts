...
const WARNING = "YOLO enabled: afx permission checks disabled";
...
function createFixture(prefix: string) {
  ...
  return {
    ...
    settingsPath: join(home, ".afx", "settings.json"),
  };
}
...
describe("yolo permission mode", () => {
  test(
    ...
    async () => {
      const fixture = createFixture("afx-yolo-headless-");
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("afx-yolo-status-");
      writeFileSync(
        fixture.settingsPath,
        JSON.stringify({
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("afx-legacy-sandbox-ps-");
...
describe.skipIf(!tmuxAvailable())("yolo interactive mode", () => {
  test(
    ...
    async () => {
      const fixture = createFixture("afx-yolo-tui-");
  ...
  test(
    ...
    async () => {
      const fixture = createFixture("afx-yolo-ctrl-c-");
      const stderrPath = join(fixture.root, "stderr.log");
      writeFileSync(
        fixture.settingsPath,
        JSON.stringify({
