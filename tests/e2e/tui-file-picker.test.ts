...
describe("@ file picker", () => {
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-stable-refresh-");
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-first-episode-refresh-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-unmatched-submit-");
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-boundaries-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-narrow-prefix-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-duplicate-basename-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-added-root-");
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-repaint-");
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-refresh-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-safety-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-typed-integration-");
      initGit(current.workspace);
      writeFileSync(
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-filesystem-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-owned-spacing-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-spacing-");
      initGit(current.workspace);
  ...
  tmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-resume-");
      initGit(current.workspace);
      writeFileSync(
  ...
  liveTmuxTest(
    ...
    async () => {
      const current = createFixture("afx-file-picker-live-");
      initGit(current.workspace);
