...
// The proxy gates this as Grok wire compatibility; afx identifies itself separately below.
...
fn streamCompletionCore(alloc: Allocator, request: stream_provider.Request) !stream_provider.Result {
    ...
    extra_count += 1;
    extra_headers_buf[extra_count] = .{ .name = "x-grok-client-identifier", .value = "afx" };
    extra_count += 1;
