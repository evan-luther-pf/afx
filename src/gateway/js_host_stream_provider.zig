...
extern "afx" fn fx_http_stream_open(
    method_ptr: [*]const u8,
    method_len: usize,
    url_ptr: [*]const u8,
    url_len: usize,
...
extern "afx" fn fx_http_stream_status(handle: i32, status_out: *u16) i32;
extern "afx" fn fx_http_stream_next(handle: i32, out_ptr: [*]u8, out_cap: usize) i32;
extern "afx" fn fx_http_stream_close(handle: i32) void;
