...
pub const BackendSelection = struct {
    preferred: ?[]const web_search_contract.SearchBackendId = null,
    excluded: []const web_search_contract.SearchBackendId = &.{},
};

pub const PreferredBackendsFn = *const fn (?*anyopaque) anyerror!BackendSelection;
...
pub const Provider = struct {
    ...
    pub fn backendSelection(self: Provider) !BackendSelection {
