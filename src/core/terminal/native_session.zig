...
const launcher_mode = "--afx-internal-terminal-launcher";
const control_mode = "--afx-internal-terminal-control";
...
const TestDurableFixture = struct {
    ...
    fn init(alloc: Allocator) !TestDurableFixture {
        ...
        defer root.close();
        var afx = try io_mod.openOrCreateVerifiedPrivateDir(&root, ".afx");
        defer afx.close();
