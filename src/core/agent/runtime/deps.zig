...
pub const AgentRuntimeDeps = struct {
    ...
    rotate_gateway_credential: ?*const fn (ctx: *anyopaque, alloc: Allocator, source: types.CredentialSource, retry_after_seconds: ?u64) anyerror!?credentials.Credential = null,
