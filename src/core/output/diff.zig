...
pub const default_preview_lines: usize = 6;
...
pub const PreviewOptions = struct {
    max_lines: usize = default_preview_lines,
...
test "file change preview validates bounds and line number semantics" {
    ...
    var aggregate_text: [max_encoded_preview_bytes / max_preview_lines]u8 = undefined;
