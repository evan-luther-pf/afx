...
test "command replay reader rejects descriptor and frame corruption" {
    ...
    var malformed = try capability.createExclusiveFile(
        alloc,
        .command_artifacts,
        "afx-command-replay-malformed.bin",
    );
    ...
    try std.testing.expectError(
        ...
        Reader.open(alloc, &capability, .{
            .handle = "afx-command-replay-malformed.bin",
    ...
    const empty_handle = "afx-command-replay-empty-frame.bin";
