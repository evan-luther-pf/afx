...
extern "afx" fn fx_prompt_history_available() i32;

extern "afx" fn fx_prompt_history_load(
...
extern "afx" fn fx_prompt_history_append(
    timestamp_ms: i64,
    workspace_ptr: [*]const u8,
    workspace_len: usize,
    text_ptr: [*]const u8,
...
extern "afx" fn fx_prompt_history_clear(
    workspace_ptr: [*]const u8,
    workspace_len: usize,
) i32;
