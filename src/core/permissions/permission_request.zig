...
test "file request accepts maximum components within aggregate capacity" {
    ...
    try std.testing.expect(try fileRequestFootprint(request) <= max_file_request_footprint_bytes);
