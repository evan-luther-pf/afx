...
test "workspace add rejects effective capacity before changing settings" {
    ...
    const before = try readFixtureFile(alloc, tmp.dir, "home/.afx/settings.json");
    ...
    const after = try readFixtureFile(alloc, tmp.dir, "home/.afx/settings.json");
...
test "workspace access reconciliation accepts only intended or previous saved state" {
    ...
    try writeFixtureFile(tmp.dir, "home/.afx/settings.json", previous_fixture);
    ...
    try writeFixtureFile(tmp.dir, "home/.afx/settings.json", third_fixture);
    ...
    try writeFixtureFile(tmp.dir, "home/.afx/settings.json", invalid_fixture);
