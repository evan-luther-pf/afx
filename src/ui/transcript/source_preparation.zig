...
fn buildCompactTranscriptProjectionInterruptible(
    ...
    var projection = try tool_group_projection.buildStyledFocusedInterruptible(
        ...
        .{
            ...
            .reset_style = "\x1b[0m",
            .visual_tool_blocks = if (comptime @hasField(@TypeOf(self.*), "visual_tool_blocks"))
                self.visual_tool_blocks
            else
                false,
            .fullscreen_display = if (comptime @hasField(@TypeOf(self.*), "fullscreen_display"))
