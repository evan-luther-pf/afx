...
const defaultWasm = resolve(scriptDir, "../../zig-out/bin/afx-core.wasm");
...
const agent = await Promise.race([
  ...
  new Promise((_, reject) => setTimeout(() => reject(new Error("timed out waiting for afx-core initialize")), 5000)),
]);
