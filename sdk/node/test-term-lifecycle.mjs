...
const wasmPath = resolve(process.argv[2] || resolve(scriptDir, "../../zig-out/bin/afx-term.wasm"));
...
await waitFor(() => grid().includes("𝒂𝒇x"), "startup");
...
if (exitCode !== 0) throw new Error(`afx-term exited with ${exitCode}`);
