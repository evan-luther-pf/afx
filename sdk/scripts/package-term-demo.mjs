...
const sdkPath = resolve(repoRoot, "sdk/afx-sdk.js");
const wasmPath = resolve(repoRoot, "zig-out/bin/afx-term.wasm");
...
const sdkName = `afx-sdk.${sdkHash}.js`;
const wasmName = `afx-term.${wasmHash}.wasm`;
const packagedBrowser = Buffer.from(
  browserBytes.toString().replace('from "./afx-sdk.js";', `from "./${sdkName}";`),
);
const browserHash = digest(packagedBrowser);
const browserName = `browser.${browserHash}.js`;

const replacements = [
  ['const fxWasmAsset = "./afx-term.wasm";', `const fxWasmAsset = "./${wasmName}";`],
