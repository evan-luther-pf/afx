...
pub fn build(b: *std.Build) void {
    ...
    build_options.addOption([]const u8, "product_name", "afx");
    build_options.addOption([]const u8, "profile_dir_name", ".afx");
    build_options.addOption([]const u8, "project_config_name", ".afx.json");
    build_options.addOption([]const u8, "workspace_skills_dir", ".afx/skills");
    build_options.addOption([]const u8, "workspace_agents_dir", ".afx/agents");
    build_options.addOption([]const u8, "global_agents_dir", ".afx/agents");
    build_options.addOption(bool, "is_afx", true);
    ...
    const run_step = b.step("run", "Run afx");
...
fn addWasmArtifact(
    ...
    const description = switch (surface) {
        .core => "Build the headless afx WebAssembly artifact",
        .term => "Build the terminal afx WebAssembly artifact",
        .none => unreachable,
    };
    ...
    wasm_options.addOption([]const u8, "product_name", "afx");
    wasm_options.addOption([]const u8, "profile_dir_name", ".afx");
    wasm_options.addOption([]const u8, "project_config_name", ".afx.json");
    wasm_options.addOption([]const u8, "workspace_skills_dir", ".afx/skills");
    wasm_options.addOption([]const u8, "workspace_agents_dir", ".afx/agents");
    wasm_options.addOption([]const u8, "global_agents_dir", ".afx/agents");
    wasm_options.addOption(bool, "is_afx", false);
...
fn addNapiArtifact(
    ...
    napi_options.addOption([]const u8, "product_name", "afx");
    napi_options.addOption([]const u8, "profile_dir_name", ".afx");
    napi_options.addOption([]const u8, "project_config_name", ".afx.json");
    napi_options.addOption([]const u8, "workspace_skills_dir", ".afx/skills");
    napi_options.addOption([]const u8, "workspace_agents_dir", ".afx/agents");
    napi_options.addOption([]const u8, "global_agents_dir", ".afx/agents");
    napi_options.addOption(bool, "is_afx", false);
